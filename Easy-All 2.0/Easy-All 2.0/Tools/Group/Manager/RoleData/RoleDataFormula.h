...
#define BasicHealth_PaRe    300   //基础值
#define BasicIncHealth_PaRe 50    //基础增长值
#define AddIncHealth_PaRe   10    //额外增长值
...
#define BasicEnergy_PaRe    50   //基础值
#define BasicIncEnergy_PaRe 2    //基础增长值
#define AddIncEnergy_PaRe   1    //额外增长值
...
#define BasicAttack_PaRe    50   //基础值
...
#define BasicCriticalStrike_PaRe    0.05   //基础值
